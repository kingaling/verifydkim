...
That code does exactly what my verifydkim2.py script does. It provides a replacement to the internal dkim command get_text(). I did the same thing but I renamed it. I wanted to flip a table but I didn't because I still enjoyed learning about how DKIM works as well as learnign some more Python stuff. :)
